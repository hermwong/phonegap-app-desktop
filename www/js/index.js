...
var copyPath1, execPath1, tempPath1;
...
if(gui.App.argv.length) {
    ...
    //tempPath1 = gui.App.argv[2];

    console.log("copyPath1: " + copyPath1);
    console.log("execPath1: " + execPath1);
    //console.log("tempPath1: " + tempPath1);
    ...
    upd.install(copyPath1, function(err) {
        if(!err) {
            ...
            //shell.cp('-r', execPath1, copyPath1); // causes crash...
            //gui.App.quit();
        }
    });
} else {
